package isa.factorial.bdd; // Debe coincidir con la carpeta donde está este archivo
...
@SelectPackages("isa.factorial")
// 2. Apuntamos al paquete exacto donde está FactorialSteps.java
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "isa.factorial.bdd")
